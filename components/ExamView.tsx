...
const ExamView: React.FC<ExamViewProps> = ({ onBack, onFinish, userName }) => {
  ...
  useEffect(() => {
    setQuestions(getRandomQuestions(100)); // Get 100 random questions
  }, []);
  ...
  const handleRetry = () => {
    ...
    setAnswers([]);
    setTimeLeft(100 * 60);
    setQuestions(getRandomQuestions(100));
  };
      ...
      <div className="max-w-2xl mx-auto py-10 px-4 text-center">
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-blue-100">
            ...
            <p className="text-slate-600 mb-8 leading-relaxed">
                Anda akan mengerjakan <strong>100 Soal Pilihan Ganda</strong> yang mencakup Mindset, Fundamental, Teknikal, dan Bandarmologi.
                <br/><br/>
                Waktu pengerjaan: <strong>100 Menit</strong>.<br/>
                Syarat Lulus: Nilai min. <strong>80</strong>.
            </p>
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        {isPassed ? (
            ...
            <div className="max-w-lg mx-auto text-center mt-20">
                ...
                <p className="text-slate-500 mb-6">Nilai Anda: <span className="font-bold text-red-500">{score}</span>. Syarat lulus minimal 80.</p>
                ...
                <button onClick={handleRetry} className="w-full px-6 py-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 shadow-lg">
                    Coba Ujian Lagi
                </button>
